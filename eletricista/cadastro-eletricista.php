...
<?php
    ...
    $acao = isset($_GET['acao']) ? $_GET['acao'] : "salvarEletri";
    if($acao == "salvarEletri"){
        $pagina = "Cadastro";
    } else{
    ...
    $json = json_decode(file_get_contents($caminhoGerente), true);
?>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <input type="hidden" name="id" id="id" value="<?=$id?>">
            ...
            <div class="row mt-3">
                <div class="col-3">
                    ...
                    <select name="gerente" id="gerente" class="form-select border-success text-center" required>
                        <option value="selecione">Selecione um gerente...</option>
                        <?php
                            foreach($json as $value){
                                if($id != 0){
                                    if($vet['gerente'] == $value['nome']){
            ...
            <div class="row mt-4">
                ...
                <div class="col-1">
                    <button class="btn secundario border-success branco texto" type="submit" name="acao" id="acao" value="<?=$acao?>">Salvar</button>
                </div>
            </div>
        </form>
    </div>
